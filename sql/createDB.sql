...
CREATE TABLE `badge_sync` ( `id_badge` bigint(20) NOT NULL, `id_user` int(11), PRIMARY KEY (`id_badge`), FOREIGN KEY (`id_user`) REFERENCES `user_sync` (`id_user`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
