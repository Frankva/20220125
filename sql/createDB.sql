...
CREATE TABLE `log_sync` ( `date` datetime NOT NULL, `id_badge` bigint(20) NOT NULL, `inside` tinyint(1) NOT NULL, `id_log` int(11) NOT NULL, `id_user` int(11), PRIMARY KEY (`id_log`), FOREIGN KEY (`id_badge`) REFERENCES `badge_sync` (`id_badge`), FOREIGN KEY (`id_user`) REFERENCES `user_sync` (`id_user`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
